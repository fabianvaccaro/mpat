function [ matriz_entrenamiento, salidas_esperadas, nombresArchivos ] = entrenar_batchPAR(dataPath, hs, hr, minreg, umbral, signo, formato )
...
%Añade al path
addpath(dataPath,'../../database/','../../databaseEcu2/A/','../captura/','../estadistica/','../extraccion/','../interfaz/','../representacion/','../scripts/','../segmentacion/');
...
parfor i = 1:total_muestras
    ...
    linea_caracteristicas  = MPAT_SECOND( estructura_imagen, umbral, signo );
    
    %registra la linea en la matriz de entrenamiento
    matriz_entrenamiento(i,:) = linea_caracteristicas(1,1:120);
