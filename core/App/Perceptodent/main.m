...
% Last Modified by GUIDE v2.5 04-Sep-2015 17:14:19
...
set(handles.Tabla1, 'ColumnName', handles.columnas);
...
[ matriz_entrenamiento, salidas_esperadas, nombresArchivos ] = ProcesarDirectorio(handles.directorio );
...
%inicializa la tabla con los EVFs validados
handles = pupularTabla(StRes, handles.clases, handles.VALIDATED_Indexes, handles);
...
set(handles.Tabla1, 'RowName', filas);
...
for i=1:length(StRes.KolmogorovSmirnov)
   if(StRes.KolmogorovSmirnov(i)== 1 && StRes.ANOVA_P(i) < 0.05 && StRes.SP_RHO(i) >=0.6 && StRes.SP_P(i) <0.05)
